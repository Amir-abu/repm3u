...
settingWin.innerHTML = '<span class="t">Reproductor IPTV M3U Playlist</span><span id="win_close" class="dismiss">✕</span><div class="ent"><input type="text"" id="m3uVal" value="https://www.example.com/Playlist.m3u" placeholder="Introduce la URL de una lista M3U"><input type="button" id="doneBtn" value="OK"></div><br><br><br><br><br><br><div align="center"><p>Pulsa OK para cargar nuestra Lista de Canales M3U<br>o pega un enlace de una lista M3U. Ejemplo:<br>https://example.com./canales.m3u</a></div>';
